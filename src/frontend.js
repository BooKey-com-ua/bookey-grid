...
import WpPlugin from './lib/WpPlugin';

//import from store
import * as mobxStores from './lib/Store';
...
// if (typeof inbound !== 'undefined') console.log(inbound);
  ...
  <StrictMode>
    <MobxProvider {...mobxStores}>
      <ChakraProvider theme={theme}>
        <WpPlugin { ...((typeof inbound !== 'undefined') ? { error: inbound?.error === 'true', language: inbound.language, plugin: inbound.plugin, user: inbound.user } : {}) } />
      </ChakraProvider>
    </MobxProvider>
  </StrictMode>
);
